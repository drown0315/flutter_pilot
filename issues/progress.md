...
| 4. Replace Run With Test Command | `#85` | Not started | Target Device resolution and Target App launcher prerequisites are complete; replacing `run` with `test` is next. |
